...
make_group(group3_b,
	...
	/*mul_rm2a_b*/inv, imul_rm2a_b, inv, inv)

/* 0xf7 */
make_group(group3_v,
	inv, inv, inv, neg_rm_v, 
	/*mul_rm2a_v*/inv, imul_rm2a_v, inv, inv)
...
/* 0x94 */	xchg_a2r_v,	xchg_a2r_v,	xchg_a2r_v, inv,
